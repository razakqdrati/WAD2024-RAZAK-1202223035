...
if (isset($_GET['id'])) {
    $id_student = $_GET["id"];
    $name = $_POST["nama"];
    $nim_student = $_POST["nim"];
    $jurusan_student = $_POST["jurusan"];
    $angkatan_student = $_POST["angkatan"];

    
    // bikin variabel $student yang menyimpan hasil query
    $student = "UPDATE tb_student SET nama ='$name', 
    nim ='$nim_student', jurusan='$jurusan_student', 
    angkatan='$angkatan_student' WHERE id ='$id_student'";

    $test = mysqli_query($conn, $student);
}
